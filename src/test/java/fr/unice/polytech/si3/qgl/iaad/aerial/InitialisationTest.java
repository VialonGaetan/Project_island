...
public class InitialisationTest
{
    ...
    public void nextAction() throws Exception
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            initialisation.setResult(area.putResults(DroneTest.createEchoJSON(10, mapSize[i], Element.OUT_OF_RANGE.toString()).toString()));
        }
    ...
    public void setResult() throws Exception
    {
        ...
        assertTrue(initialisation.setResult(area) instanceof Initialisation.EchoToFindLimit);

        area.putResults(DroneTest.createEchoJSON(10, 12, Element.GROUND.toString()).toString());
        assertTrue(initialisation.setResult(area) instanceof FlyToIsland);
    }
