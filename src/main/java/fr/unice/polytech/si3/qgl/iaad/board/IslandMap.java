...
public class IslandMap
{
    ...
    /*
     * Saves what dimensions are finished in the board
     */
    ...
    /**
     * Default constructor
     * Builds the body of the board as an unique point with (0, 0) as coordinates
    ...
    /**
     * Converts the aerial board in land board
     */
    boolean zoom()
    {
        boolean done = true;
    ...
    /**
     * Informs if the point at coordinates(x, y) exists in the board
     ...
     * Changes dimensions of the board
    ...
    /**
     * new Fly(direction) in the board
    ...
    boolean isAnOldAerialLocation(Point point) throws InvalidMapException { return bodyMap.getSquare(point).isAnOldAerialLocation(); }

    boolean isAnOldGroundLocation(Point point) throws InvalidMapException { return bodyMap.getSquare(point).isAnOldGroundLocation(); }
    ...
    /**
     * Informs if the board is finished
     ...
     * @param direction, direction to set fr.unice.polytech.si3.qgl.iaad.ground
     * @param numberOfPoints, number of points to add to board
     */
    ...
    Element[] getElements(Point point) throws InvalidMapException { return bodyMap.getSquare(point).getElements(); }
