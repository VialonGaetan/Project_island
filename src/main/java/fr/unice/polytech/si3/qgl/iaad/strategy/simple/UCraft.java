...
import fr.unice.polytech.si3.qgl.iaad.engine.player.results.TransformResultat;
...
public class UCraft implements Protocol {
    ...
    private TransformResultat result;
    ...
    UCraft(Resource resource, SecondContract secondContract){
        ...
        if (resource.getReagent1()!=null && resource.getReagent2()!=null)
            this.action=new Transform(resource.getReagent1(), resource.getReagent2(), resource.getQte1(), resource.getQte2());
        if (resource.getReagent1()!=null && resource.getReagent2()==null)
            this.action=new Transform(resource.getReagent1(),null, resource.getQte1(),0);
