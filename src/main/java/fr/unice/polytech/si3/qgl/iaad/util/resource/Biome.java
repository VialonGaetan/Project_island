...
public enum Biome {
    ...
    Biome(double crossFactor, ResourceEntry... resourceEntries)
    {
        this.crossFactor = crossFactor;
        this.resourceMap = new ResourceMap(resourceEntries);
    }
    ...
    public List<PrimaryResource> getAssociateResources()
    {
