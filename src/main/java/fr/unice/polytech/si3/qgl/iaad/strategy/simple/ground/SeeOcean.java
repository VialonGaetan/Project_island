...
public class SeeOcean implements Protocol{
    ...
    public SeeOcean(int range,Compass direction, Map contrat,Crew crew, IslandMap map) {
    ...
    public SeeOcean(Compass direction, Map contrat, Crew crew, IslandMap map) {
        this.direction = direction;
        this.range = 4;
        this.crew = crew;
        this.map = map;
    ...
    public Protocol acknowledgeResults(Result result) {
        ...
        if (viewOcean(glimpseResult.getGlimpseInformation()))
            return new UTurn(direction.get(Direction.BACK),contrat,crew,map);
